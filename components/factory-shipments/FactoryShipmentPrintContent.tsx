/**
 * FactoryShipmentPrintContent - 厂家发货单打印内容组件
 *
 * 功能：
 * - 支持DIY样式配置
 * - 支持字段选择
...
function calculateTotalWeight(
  items: FactoryShipmentOrder['items'] | undefined
): number {
...
/**
 * FactoryShipmentPrintContent 组件
 */
export function FactoryShipmentPrintContent({
  ...
  const getFieldConfig = (key: string) =>
    factoryShipmentPrintConfig.fields.find(f => f.key === key);
