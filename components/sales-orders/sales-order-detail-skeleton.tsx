            ...
            <div className="grid grid-cols-2 gap-4">
              {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                <div key={i} className="space-y-2">
                  ...
                  <div
                    className={`h-5 w-32 animate-pulse rounded bg-gray-300 skel-delay-${Math.min(i, 10)}`}
                  />
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="flex justify-between">
                  ...
                  <div
                    className={`h-4 w-32 animate-pulse rounded bg-gray-300 skel-delay-${Math.min(i, 10)}`}
                  />
                </div>
              ))}
            </div>
