...
export const Captcha = React.forwardRef<HTMLCanvasElement, CaptchaProps>(
  ({ width = 120, height = 40, length = 4, onCaptchaChange, className }, ref) => {
    ...
    return (
      <div className={cn('flex items-center gap-2', className)}>
        <canvas
          ...
          width={width}
          height={height}
          className="border border-input rounded cursor-pointer"
...
// 验证码验证函数
export const verifyCaptcha = (userInput: string, correctCaptcha: string): boolean => {
