...
const MobileSearchBar = React.forwardRef<HTMLDivElement, MobileSearchBarProps>(
  ({
    ...
    const currentSortLabel = React.useMemo(() => {
      ...
      const sortOption = sortOptions.find(option => option.key === value.sort?.key)
                  ...
                  {sortOptions.map((sort) => (
                    <div key={sort.key} className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <Button
                          variant={
                            value.sort?.key === sort.key && value.sort?.direction === 'asc'
                              ? 'default'
                              : 'outline'
                          }
                          size="sm"
                        ...
                        <Button
                          variant={
                            value.sort?.key === sort.key && value.sort?.direction === 'desc'
                              ? 'default'
                              : 'outline'
                          }
                          size="sm"
...
export { MobileSearchBar, type SearchState, type FilterOption, type SortOption }
