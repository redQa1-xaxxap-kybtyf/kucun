...
import { Calendar, ChevronLeft, ChevronRight, CalendarDays, Package } from "lucide-react"
...
// 生产日期格式定义
export type ProductionDateFormat = 'YYYY-MM-DD' | 'YYYY-MM' | 'YYYYMMDD' | 'YYYY年MM月DD日'
...
const ProductionDatePicker = React.forwardRef<HTMLDivElement, ProductionDatePickerProps>(
  ({
    value,
    onValueChange,
    format = 'YYYY-MM-DD',
      ...
      <div className={cn("relative", className)} ref={ref} {...props}>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isTodayDate && highlightToday && !isSelected && "bg-accent font-medium",
        ...
        <div className="mt-2">
          ...
          <Input
            ...
            placeholder={`格式: ${format === 'YYYY-MM-DD' ? '2024-01-01' : 
                                format === 'YYYY-MM' ? '2024-01' :
                                format === 'YYYYMMDD' ? '20240101' : '2024年01月01日'}`}
...
const ProductionDateRangePicker = React.forwardRef<HTMLDivElement, ProductionDateRangePickerProps>(
  ({
    startDate,
    endDate,
    onStartDateChange,
    ...
    return (
      <div className={cn("grid grid-cols-1 md:grid-cols-2 gap-4", className)} ref={ref} {...props}>
        <div>
