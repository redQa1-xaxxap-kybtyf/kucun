...
const ColorCodeDisplay = React.forwardRef<HTMLDivElement, ColorCodeDisplayProps>(
  ({ 
    className, 
    variant, 
    size, 
...
const ColorCodeSelector = React.forwardRef<HTMLDivElement, ColorCodeSelectorProps>(
  ({ 
    value, 
    onValueChange, 
    ...
    return (
      <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <button
          type="button"
          className={cn(
            "flex items-center justify-between w-full px-3 py-2 text-sm border border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-md",
