    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="h-8 w-48 animate-pulse rounded bg-[hsl(var(--color-border-strong))]" />
            ...
            <div className="grid grid-cols-2 gap-4">
              {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                <div key={i} className="space-y-2">
                  ...
                  <div
                    className={`h-5 w-32 animate-pulse rounded bg-[hsl(var(--color-border-strong))] skel-delay-${Math.min(i, 10)}`}
                  />
                </div>
              ))}
            </div>
            ...
            <div className="space-y-3">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="flex justify-between">
                  ...
                  <div
                    className={`h-4 w-32 animate-pulse rounded bg-[hsl(var(--color-border-strong))] skel-delay-${Math.min(i, 10)}`}
                  />
                </div>
              ))}
            </div>
              ...
              {[1, 2, 3].map(i => (
                ...
                >
                  <div className="flex justify-between">
                    ...
                    <div className="h-4 w-20 animate-pulse rounded bg-[hsl(var(--color-border-strong))]" />
                  </div>
                  <div
            ...
            <div className="space-y-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="space-y-2">
                  <div className="h-4 w-20 animate-pulse rounded bg-[hsl(var(--color-border-secondary))]" />
                  <div
                    className={`h-8 w-24 animate-pulse rounded bg-[hsl(var(--color-border-strong))] skel-delay-${Math.min(i, 10)}`}
                  />
                </div>
              ))}
            </div>
