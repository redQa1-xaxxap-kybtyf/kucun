 ...
 * 获取库存列表
 */
export async function getInventories(params: InventoryQueryParams): Promise<PaginatedResponse<Inventory>> {
 ...
 * 入库操作
 */
export async function createInbound(inboundData: InboundCreateInput): Promise<Inventory> {
 ...
 * 出库操作
 */
export async function createOutbound(outboundData: OutboundCreateInput): Promise<Inventory> {
 ...
 * 库存调整
 */
export async function adjustInventory(adjustData: InventoryAdjustInput): Promise<Inventory> {
