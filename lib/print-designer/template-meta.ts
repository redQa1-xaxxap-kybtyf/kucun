...
export const TEMPLATE_TYPE_META: Record<TemplateType, TemplateTypeMeta> = {
  ...
  'finance-monthly-report': {
    label: '月度报表',
    shortLabel: '月报',
    description: '适合经营月报、月度汇总导图',
    supportsRealPreview: false,
    realDataLabel: '真实月报',
    recentDocumentLabel: '最近月报',
  },
  'finance-annual-report': {
    label: '年度报表',
    shortLabel: '年报',
    description: '适合年度经营汇总、趋势分析导图',
    supportsRealPreview: false,
    realDataLabel: '真实年报',
    recentDocumentLabel: '最近年报',
  },
  'finance-profit-loss-report': {
    label: '盈亏分析',
    shortLabel: '盈亏',
    description: '适合利润、成本、费用结构分析导图',
    supportsRealPreview: false,
    realDataLabel: '真实分析',
    recentDocumentLabel: '最近分析',
  },
  custom: {
    label: '自定义',
    shortLabel: '自定义',
