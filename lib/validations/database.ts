...
export const inboundRecordValidations = {
  create: z.object({
    type: z.enum(['normal_inbound', 'return_inbound', 'adjust_inbound']).default('normal_inbound'),
    productId: baseValidations.id,
    colorCode: z.string().max(50, '色号不能超过50个字符').optional(),
    productionDate: z.string().optional(),
...
export type UserUpdatePasswordInput = z.infer<typeof userValidations.updatePassword>
...
export type SalesOrderCreateInput = z.infer<typeof salesOrderValidations.create>
export type SalesOrderUpdateInput = z.infer<typeof salesOrderValidations.update>
...
export type InboundRecordCreateInput = z.infer<typeof inboundRecordValidations.create>
