...
export type BatchDeleteCustomersData = z.infer<typeof BatchDeleteCustomersSchema>
 ...
 * 格式化客户联系方式
 */
export function formatCustomerContact(phone?: string, address?: string): string {
  const parts = []
