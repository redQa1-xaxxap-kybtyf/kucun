...
const envSchema = z.object({
  ...
  SHIPPING_QUERY_SITE_COOLDOWN_MS: z
    .string()
...
export const shippingQuerySchedulerConfig = {
  ...
  siteCooldownMs: env.SHIPPING_QUERY_SITE_COOLDOWN_MS,
...
if (isDevelopment) {
  ...
  // eslint-disable-next-line no-console
  console.log(
    `  - 运输查询调度: 间隔${env.SHIPPING_QUERY_INTERVAL_HOURS}小时/最小间隔${env.SHIPPING_QUERY_MIN_INTERVAL_HOURS}小时/站点冷却${env.SHIPPING_QUERY_SITE_COOLDOWN_MS}ms/启用${env.SHIPPING_QUERY_AUTO_ENABLED}`
  );
}
