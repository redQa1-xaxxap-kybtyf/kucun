  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="space-y-2">
        <h1 className="text-foreground text-3xl font-bold">仪表板</h1>
        <p className="text-muted-foreground">查看您的业务概况和关键指标</p>
      </div>
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-primary hover:bg-primary/90">新建订单</Button>
      </div>

      {/* 搜索和筛选 */}
      <div className="flex items-center space-x-4">
        <Input placeholder="搜索订单号、客户名称..." className="max-w-sm" />
      ...
      <DataTable
        ...
        columns={[
          ...
          { key: 'customerName', header: '客户' },
          {
            ...
            header: '状态',
            cell: value => (
              <StatusBadge status={getStatusType(value)}>{value}</StatusBadge>
            ),
          },
          {
            key: 'amount',
...
_此实施指南提供了完整的代码示例和最佳实践，帮助您快速应用 ERP 配色方案到实际项目中。_
