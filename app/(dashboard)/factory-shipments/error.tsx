...
export default function FactoryShipmentsError({
  ...
  useEffect(() => {
    // 上报错误到监控服务
    reportErrorBoundary(error, 'FactoryShipmentsError', {
      pageTitle: '厂家发货管理',
      route: '/factory-shipments',
    });
  }, [error]);

  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      <Card className="rounded-md border border-[hsl(var(--color-error))] bg-[hsl(var(--color-error-light))] shadow-sm">
