  ...
  return (
    <div className="flex h-full flex-col overflow-hidden p-4 sm:p-6">
      <div className="space-y-4 sm:space-y-6">
        {/* 页面标题卡片 */}
        <div className="overflow-hidden rounded-lg border bg-gradient-to-r from-blue-50 to-indigo-50 p-4 shadow-sm dark:from-blue-950/20 dark:to-indigo-950/20 sm:p-6">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              ...
              className="inline-flex h-9 items-center justify-center gap-2 rounded-md border bg-background px-3 py-2 text-xs font-medium shadow-sm transition-all hover:bg-accent hover:text-accent-foreground sm:h-11 sm:px-4 sm:text-sm"
            >
