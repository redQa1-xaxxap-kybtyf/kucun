...
export function SupplierDetailPageClient({
  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      <div className="mx-auto max-w-[1680px] space-y-6 p-4 lg:p-8 xl:p-10">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4">
          <div className="lg:col-span-3">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-3 rounded-lg border border-rose-100 bg-rose-50 p-5 shadow-sm">
                <div className="flex items-center gap-3">
          ...
          <Tabs defaultValue="shipments" className="w-full">
            <div className="mb-4 flex items-center justify-between px-5">
              <TabsList className="h-10 rounded-md border bg-slate-100 p-1">
                <TabsTrigger
                  value="shipments"
                  className="h-8 rounded px-4 text-sm font-medium data-[state=active]:bg-white"
                >
            ...
            <div className="space-y-3 p-2">
              ...
              >
                {supplier.factoryShipments.length > 0 ? (
                  <div className="grid gap-3 px-3 pb-3">
                    {supplier.factoryShipments.map(shipment => (
                      <div
                        ...
                        className="flex cursor-pointer items-center justify-between rounded-lg border bg-white p-4 transition-colors hover:border-slate-300"
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div className="space-y-1">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="rounded-md border border-slate-200 bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-500">
                                {shipment.status}
                              </div>
                            </div>
                  ...
                  <div className="m-3 flex flex-col items-center justify-center rounded-lg border border-dashed border-slate-200 bg-slate-50 py-12">
                  ...
                  <div className="grid gap-3 px-3 pb-3">
                    {supplier.payableRecords.map(record => (
                      <div
                        ...
                        className={cn(
                          'flex cursor-pointer items-center justify-between rounded-lg border p-4 transition-colors hover:border-slate-300',
