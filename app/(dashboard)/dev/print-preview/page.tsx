...
const testTemplate: PrintTemplate = {
  ...
  elements: [
    ...
    // 明细表格
    {
      ...
      dataSource: 'items',
      columns: [
        { key: 'name', label: '产品名称', width: 35, widthUnit: '%', align: 'left', format: 'text' },
        { key: 'spec', label: '规格', width: 20, widthUnit: '%', align: 'center', format: 'text' },
        { key: 'quantity', label: '数量', width: 15, widthUnit: '%', align: 'right', format: 'number' },
        { key: 'unitPrice', label: '单价', width: 15, widthUnit: '%', align: 'right', format: 'currency' },
        { key: 'subtotal', label: '金额', width: 15, widthUnit: '%', align: 'right', format: 'currency' },
      ],
      style: {
...
const testData = {
  ...
  items: [
    { name: '800x800 抛光砖', spec: '800x800mm', quantity: 100, unitPrice: 45, subtotal: 4500 },
    { name: '600x600 仿古砖', spec: '600x600mm', quantity: 200, unitPrice: 35, subtotal: 7000 },
    { name: '300x300 马赛克', spec: '300x300mm', quantity: 50, unitPrice: 25, subtotal: 1250 },
  ],
  totalAmount: 12750,
};
