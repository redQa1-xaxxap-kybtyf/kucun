...
import { ArrowLeft, Loader2, Plus, RefreshCw, Search, Users } from 'lucide-react';
          ...
          <CardContent className="space-y-6 p-8">
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-1 flex-wrap items-center gap-3">
                <div className="relative min-w-[300px] flex-1">
                  ...
                  <Input
                    ...
                    className="h-12 border-slate-200 pl-11 font-medium bg-slate-50/50 focus-visible:ring-blue-500"
                  />
                </div>
              ...
              <Button
                ...
                className="h-12 px-8 font-bold bg-slate-900 hover:bg-slate-800 shadow-md"
              >
            ...
            <div className="rounded-xl border border-slate-100 overflow-hidden bg-white">
                {isLoading ? (
                  <div className="flex h-64 items-center justify-center bg-slate-50/30">
                    ...
                    <span className="ml-3 font-medium text-slate-500">数据同步中...</span>
                  </div>
                ) : error ? (
            ...
            {userListData && userListData.total > 0 && (
              <div className="flex items-center justify-between py-2 px-1">
                <div className="text-xs font-medium text-slate-400">
                  ...
                  / 共 <span className="text-slate-900">{userListData.total}</span> 条存档
                </div>
