  ...
  return (
    <Card className="overflow-hidden rounded-2xl border-slate-100 shadow-sm ring-1 ring-slate-100/50">
      ...
      <CardContent className="bg-white p-6">
        <div className="relative space-y-8 before:absolute before:left-[7px] before:top-1 before:h-[calc(100%-8px)] before:w-0.5 before:bg-slate-100">
          <div className="relative flex items-start gap-4 pl-6">
            ...
            <div className="min-w-0 flex-1">
              <div className="text-[10px] font-bold uppercase tracking-wider text-slate-500">业务初始创建</div>
          ...
          {order.updatedAt !== order.createdAt && (
            <div className="relative flex items-start gap-4 pl-6">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[10px] font-bold uppercase tracking-wider text-slate-500">系统状态变更</div>
                <div className="mt-1 text-sm font-semibold text-slate-900">
                  关键业务字段更新
                </div>
                <div className="mt-1.5 flex items-center gap-3 text-[10px] text-slate-400">
