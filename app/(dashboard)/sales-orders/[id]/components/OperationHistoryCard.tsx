...
export function OperationHistoryCard({ order, userName }: { order: SalesOrderDetail; userName: string }) {
  return (
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 text-xs text-[hsl(var(--color-text-tertiary))]">{formatDateTime(order.createdAt)}</div>
              <div className="mt-0.5 text-xs text-[hsl(var(--color-text-tertiary))]">创建人：{userName}</div>
            </div>
          </div>
          {order.updatedAt !== order.createdAt && (
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-0.5 text-xs text-[hsl(var(--color-text-tertiary))]">{formatDateTime(order.updatedAt)}</div>
              </div>
            </div>
          )}
        </div>
