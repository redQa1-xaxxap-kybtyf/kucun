...
```json
{
  "@hookform/resolvers": "^5.2.2", // 升级前: ^3.10.0
...
4. **`standard-schema` resolver 仅在 `@hookform/resolvers` v4.0.0+ 中可用**
...
- **必须升级 `@hookform/resolvers` 到 v4.0.0 或更高版本**
- `standard-schema` resolver 在 v3.x 中不存在
