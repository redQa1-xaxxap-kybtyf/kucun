 ...
 */
exports.API_BASE_URL_KEY = 'api_base_url';
...
function getApiConfig() {
  // 1) 优先使用手动覆盖的 baseURL
  try {
    const override = wx.getStorageSync(exports.API_BASE_URL_KEY);
...
exports.API_ENDPOINTS = {
  ...
  COLUMN: {
    ...
    MATERIAL_DETAIL: id => `/column/materials/${id}`,
    // 方案生成
    ...
    SCHEME_DETAIL: id => `/column/schemes/${id}`,
  },
};
/**
 * 请求头配置
