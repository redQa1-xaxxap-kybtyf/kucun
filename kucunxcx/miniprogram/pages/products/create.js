...
const qiniu_upload_service_1 = __importDefault(require("../../services/qiniu-upload.service"));
Page({
    data: {
        // 是否为编辑模式
        isEditMode: false,
    ...
    async uploadImage(filePath, kind) {
        try {
            // 使用七牛云服务上传
            const result = await qiniu_upload_service_1.default.uploadImage(filePath, kind);
            // 上传成功，更新对应的状态
