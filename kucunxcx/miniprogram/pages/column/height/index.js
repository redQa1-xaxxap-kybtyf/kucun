...
Page({
  data: {
    ...
    confirmMessage: '',
    /** 最小高度 */
    minHeight: column_calculator_1.MIN_HEIGHT,
    /** 最大高度 */
    maxHeight: column_calculator_1.MAX_HEIGHT,
  },
  onLoad() {
    // 恢复之前的状态（如果有）
  ...
  onHeightBlur() {
    ...
    if (targetHeight > 0) {
      const result = (0, column_calculator_1.validateHeight)(targetHeight);
      if (!result.valid) {
   ...
   */
  formatHeight(mm) {
    return (0, column_calculator_1.formatHeight)(mm);
  },
});
