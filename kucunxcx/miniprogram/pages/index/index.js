...
Page({
    ...
    async loadHotProducts() {
        ...
        const items = (res.items || []).filter(item => {
            const available = item.inventory && typeof item.inventory.availableQuantity === 'number'
        ...
        items.sort((a, b) => {
            const aQty = a.inventory && typeof a.inventory.availableQuantity === 'number'
                ? a.inventory.availableQuantity
                : 0;
            const bQty = b.inventory && typeof b.inventory.availableQuantity === 'number'
