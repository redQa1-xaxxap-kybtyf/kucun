...
function request(config) {
    return new Promise((resolve, reject) => {
        ...
        const requestHeaders = normalizeHeaders(Object.assign(Object.assign(Object.assign({}, api_1.DEFAULT_HEADERS), { 
            // 标记来源为小程序，便于后端中间件区分游客接口
            'x-client-from': 'mini-program' }), headers));
        // 如果需要认证，添加 Token
        if (needAuth) {
...
function get(url, params, config) {
    return request(Object.assign({ url, method: 'GET', params }, config));
}
/**
 * POST 请求
 */
...
function del(url, config) {
    return request(Object.assign({ url, method: 'DELETE' }, config));
}
/**
 * PATCH 请求
 */
