  ...
  const checks = [
    {
      ...
      check: () => {
        ...
        return !batchDeleteFunction.includes('API_BASE') && 
    ...
    },
    {
      ...
      check: () => {
        ...
        return apiCalls.every(call => 
          call.includes('/api/categories') && !call.includes('API_BASE')
        );
      }
    },
    {
      ...
      check: () => {
        ...
        return batchDeleteFunction.includes('method: \'DELETE\'') &&
    ...
    },
    {
      ...
      check: () => {
        const content = fs.readFileSync('lib/api/categories.ts', 'utf8');
        return content.includes('Promise<BatchDeleteResult>') &&
