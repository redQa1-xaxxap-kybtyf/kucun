  ...
  const checks = [
    ...
    },
    {
      ...
      check: () => {
        ...
        return (
          apiFile.includes('BatchDeleteCategoriesSchema') &&
    ...
    },
    {
      ...
      check: () => {
        ...
        return (
          typesFile.includes('BatchDeleteCategoriesInput') &&
    ...
    },
    {
      ...
      check: () => {
        ...
        return (
          apiFile.includes('batchDeleteCategories') &&
    ...
    },
    {
      ...
      check: () => {
        ...
        return (
          pageFile.includes('batchDeleteCategories,') &&
    ...
    },
    {
      ...
      check: () => {
        ...
        return (
          pageFile.includes('selectedCategoryIds') &&
    ...
    },
    {
      ...
      check: () => {
        ...
        return (
          pageFile.includes('batchDeleteMutation.isPending') &&
          pageFile.includes('Loader2') &&
